...
class StatusResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Status-Typen';

    protected static ?string $pluralModelLabel = 'Status-Typen';
    protected static ?string $modelLabel = 'Status-Typ';
